#!/usr/bin/env python3
"""
Robot Side Launch File for Distributed Deployment (LeKiwi Model)

This launch file runs on the Raspberry Pi connected to the robotic arm.
It uses the LeKiwi detailed mesh model instead of the simple arm model.

Differences from robot_side.launch.py:
- Uses lekiwi_moveit_config instead of arm_moveit_config
- Robot name: "lekiwi_arm" instead of "arm"
...
def generate_launch_description():
    # Build MoveIt configuration - KEY CHANGE: use lekiwi_moveit_config
    ...
    # NOTE: DDS QoS configuration temporarily disabled
    # Using default DDS behavior + controller timeout adjustments
